...
name: Oraxen
slug: oraxen-oraxen
source_url: https://docs.oraxen.com?format=md
fetched_at: 2026-06-07T21:17:15.169Z
adapter: oraxen
---
# Oraxen — condensed reference
> Condensed by mcwrench/learn-plugin-docs from <https://docs.oraxen.com?format=md>. Full text in RAW.md. Verify against the live docs for anything safety-critical.
