...
> Condensed by mcwrench/learn-plugin-docs from <https://raw.githubusercontent.com/IntellectualSites/PlotSquared/HEAD/README.md>. Full text in RAW.md. Verify against the live docs for anything safety-critical.
